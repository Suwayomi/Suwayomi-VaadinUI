...
public class SearchService {
  ...
  public SearchResponse quickSearch(String query, long sourceId, int pageNum) {
    ...
    SourceFilterData sourceFilterData = new SourceFilterData(query);

    return searchClient.quickSearch(baseUrl, sourceId, searchQueryParameters, sourceFilterData);
  }
