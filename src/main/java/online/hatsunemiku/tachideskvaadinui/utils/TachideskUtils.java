...
public class TachideskUtils {
  ...
  private static final Pattern JAR_PATTERN = Pattern.compile(
      "https://github\\.com/Suwayomi/Tachidesk-Server-preview/releases/download/v\\d+\\.\\d+\\.\\d+-r\\d+/(Tachidesk-Server-v(\\d+\\.\\d+\\.\\d+)-r(\\d+)\\.jar)");

  public static String getNewestJarUrl(RestTemplate client) {
    String githubApi = "https://api.github.com/repos/Suwayomi/Tachidesk-Server-preview/releases/latest";
