...
public class FirstInitService {
   ...
   * @param objectMapper The {@link JsonMapper} used to read and write the initialization check
   *     file
   * @param suwayomiSettingsService The {@link SuwayomiSettingsService} to change the Suwayomi
   *     settings
   */
  public FirstInitService(
      Environment env, JsonMapper objectMapper, SuwayomiSettingsService suwayomiSettingsService) {
