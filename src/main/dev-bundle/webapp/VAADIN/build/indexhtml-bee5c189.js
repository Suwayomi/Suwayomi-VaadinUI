...
This is probably caused by illegal octal escape sequences.`),{_$litType$:i,strings:e,values:t}),E=fi(Nn),uo=fi(xe),H=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),zt=new WeakMap,F=z.createTreeWalker(z,129,null,!1);let W=Ne;const Pn=(i,e)=>{const t=i.length-1,n=[];let o=e===xe?"<svg>":"",r,s=ee;for(let a=0;a<t;a++){const d=i[a];let c=-1,u,h=0,p;for(;h<d.length&&(s.lastIndex=h,p=s.exec(d),p!==null);)if(h=s.lastIndex,s===ee){if(p[Vt]==="!--")s=Mt;else if(p[Vt]!==void 0)s=Ut;else if(p[je]!==void 0)pi.test(p[je])&&(r=new RegExp(`</${p[je]}`,"g")),s=U;else if(p[Tn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===U?p[xn]===">"?(s=r??ee,c=-1):p[Ft]===void 0?c=-2:(c=s.lastIndex-p[Rn].length,u=p[Ft],s=p[Bt]===void 0?U:p[Bt]==='"'?qe:Ge):s===qe||s===Ge?s=U:s===Mt||s===Ut?s=ee:(s=U,r=void 0);console.assert(c===-1||s===U||s===Ge||s===qe,"unexpected parse state B");const G=s===U&&i[a+1].startsWith("/>")?" ":"";o+=s===ee?d+Sn:c>=0?(n.push(u),d.slice(0,c)+st+d.slice(c)+O+G):d+O+(c===-2?(n.push(void 0),a):G)}const l=o+(i[t]||"<?>")+(e===xe?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class Yn extends Kn{constructor(e){var t;if(super(e),e.type!==Gn.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,o;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(s))&&this._previousClasses.add(s);return this.render(t)}const r=e.element.classList;this._previousClasses.forEach(s=>{s in t||(r.remove(s),this._previousClasses.delete(s))});for(const s in t){const l=!!t[s];l!==this._previousClasses.has(s)&&!(!((o=this._staticClasses)===null||o===void 0)&&o.has(s))&&(l?(r.add(s),this._previousClasses.add(s)):(r.remove(s),this._previousClasses.delete(s)))}return H}}const mi=qn(Yn),et="css-loading-indicator";var N;(function(i){i.IDLE="",i.FIRST="first",i.SECOND="second",i.THIRD="third"})(N||(N={}));class w extends j{constructor(){super(),this.firstDelay=450,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=N.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=b.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,t;const n=window;return!((e=n.Vaadin)===null||e===void 0)&&e.connectionIndicator||(n.Vaadin=n.Vaadin||{},n.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(n.Vaadin.connectionIndicator)),(t=n.Vaadin)===null||t===void 0?void 0:t.connectionIndicator}render(){return E`
...
`,g=class extends j{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[x`
    ...
    `}render(){return E` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,we(()=>import("./component-picker-55dc29eb.js"),[],import.meta.url)}}
        >
